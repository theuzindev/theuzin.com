<div x-data="{ hasResult: @entangle('result') }">
    ...
    <div class="flex justify-evenly items-center mt-14">
        <button wire:click="food" class="bg-white hover:animate-pulse hover:bg-gray-50 hover:scale-110 hover:transition-all rounded-full p-10 shadow-md shadow-red-200">
        ...
        <button wire:click="style" class="bg-white hover:animate-pulse hover:bg-gray-50 hover:scale-110 hover:transition-all rounded-full p-7 shadow-md shadow-yellow-200">
        ...
        <button wire:click="game" class="bg-white hover:animate-pulse hover:bg-gray-50 hover:scale-110 hover:transition-all rounded-full p-7 shadow-md shadow-blue-200">
        ...
        <button wire:click="book" class="bg-white hover:animate-pulse hover:bg-gray-50 hover:scale-110 hover:transition-all rounded-full p-7 shadow-md shadow-green-200">
    ...
    <div
        ...
        x-cloak
    >
        <div wire:loading class="p-10 bg-gray-200 animate-pulse rounded-lg text-center text-xl">Loading...</div>
        <div wire:loading.remove class="bg-white flex w-full p-14 text-2xl rounded-lg">
            {{ $result }}
        </div>
    </div>
</div>
